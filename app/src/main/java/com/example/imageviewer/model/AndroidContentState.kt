...
import com.example.imageviewer.model.filtration.FiltersManager
import com.example.imageviewer.utils.clearCache
import com.example.imageviewer.utils.isInternetAvailable
import com.example.imageviewer.view.showPopUpMessage
...
object ContentState {
    ...
    fun applyContent(context: Context, uriRepository: String): ContentState {
        if (this::uriRepository.isInitialized && ContentState.uriRepository == uriRepository) {
            return this
        }

        ContentState.context = context
        ContentState.uriRepository = uriRepository
...
private object MainImageWrapper {
    ...
    fun wrapPicture(picture: Picture) {
        MainImageWrapper.picture.value = picture
    }
